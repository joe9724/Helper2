...
public class CommonMainActivity extends AppCompatActivity implements View.OnClickListener, LocationSource,AMapLocationListener
{
 RelativeLayout layout_grxx,layout_kfjl,layout_yjfk,layout_zx;
 Intent i;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		layout_grxx.setOnClickListener(this);
		layout_kfjl.setOnClickListener(this);
		...
		//
		int width = MyApplication.phonewidth- DensityUtil.dip2px(CommonMainActivity.this, (float) 30.0);
		int half_width = width /2;
		int big_width = MyApplication.phonewidth- DensityUtil.dip2px(CommonMainActivity.this, (float) 20.0);
		int height = ((MyApplication.phoneheight- DensityUtil.dip2px(CommonMainActivity.this, (float) 55.0))-DensityUtil.dip2px(CommonMainActivity.this, (float) 50.0)-statusbar_Height())/4;
		...
		int densityvalue = DensityUtil.dip2px(CommonMainActivity.this,10);
	...
	public void onClick(View view) {
		switch (view.getId())
		{
			...
			case R.id.layout_grxx:
				...
				//康复记录
			case R.id.layout_kfjl:
				i = new Intent(this,MyRecordActvitity.class);
				startActivity(i);
				break;
		...
		if (PermissionsUtil.hasPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
			...
			PermissionsUtil.requestPermission(this, new PermissionListener() {
				...
				public void permissionDenied(@NonNull String[] permissions) {
					Toast.makeText(CommonMainActivity.this, "用户拒绝了定位权限,无法获取到具体位置!", Toast.LENGTH_LONG).show();
				}
